...
{
    public class StartupSPA
    {
        public StartupSPA(IConfiguration configuration)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configuration.RootPath = StartupSPA.ClientAppDir + "/build";// "ClientApp/build";
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSpa(spa =>
            {
                spa.Options.SourcePath = StartupSPA.ClientAppDir;// "ClientApp";
                if (env.IsDevelopment())
                {
